...
def run_benchmark(exe, inputs, summary):
    ...
    for input_file in inputs:
        ...
        perf_cmd = ["perf", "stat", "-d", "-r", n, exe, input_file]
...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        print("Usage: benchmark.py <ext> <inputs> <summary>")
        sys.exit(1)
